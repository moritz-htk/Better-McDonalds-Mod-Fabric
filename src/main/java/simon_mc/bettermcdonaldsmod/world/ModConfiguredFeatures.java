...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        register(context, SALT_BLOCK_KEY, Feature.DISK, new DiskFeatureConfig(
                PredicatedStateProvider.of(ModBlocks.SALT_BLOCK),
                BlockPredicate.matchingBlocks(List.of(Blocks.DIRT, Blocks.SAND)),
