...
public class ModItems {
    ...
    public static final Item TOMATO = registerItem("tomato", new Item(new FabricItemSettings().food(registerFoodValues(2, 1f).build())));
    ...
    public static final Item TORTILLA = registerItem("tortilla", new Item(new FabricItemSettings().food(registerFoodValues(3, 1.5f).build())));
    ...
    public static final Item COOKED_BACON = registerItem("cooked_bacon", new Item(new FabricItemSettings().food(registerFoodValues(5, 2.5f).meat().build())));
    ...
    public static final Item MCBACON = registerItem("mcbacon", new Item(new FabricItemSettings().food(registerFoodValues(10, 5f).build())));
    ...
    public static final Item COCA_COLA = registerItem("coca_cola", new DrinkItem(new FabricItemSettings().food(registerFoodValues(4, 2f).build())));
    public static final Item FANTA = registerItem("fanta", new DrinkItem(new FabricItemSettings().food(registerFoodValues(4, 2f).build())));
    public static final Item SPRITE = registerItem("sprite", new DrinkItem(new FabricItemSettings().food(registerFoodValues(4, 2f).build())));
    public static final Item LIPTON_ICE_TEA_PEACH = registerItem("lipton_ice_tea_peach", new DrinkItem(new FabricItemSettings().food(registerFoodValues(4, 2f).build())));
